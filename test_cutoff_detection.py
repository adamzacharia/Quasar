...
test_queries = [
    ...
    ("What is the latest ALMA cycle?", True),
    ("Search ALMA for TW Hya observations", False),
    ("What recent data releases are available this year?", True),
...
for query, expected in test_queries:
    ...
    status = "✅" if detected == expected else "❌ WRONG"
...
if "🌐 Web Search Results" in response:
    print("\n\n✅ WEB SEARCH RESULTS SECTION FOUND IN RESPONSE!")
else:
    print("\n\n⚠️  No web search results section found")
