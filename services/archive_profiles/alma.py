...
PROFILE = ArchiveProfile.model_validate(
    {
        ...
        "query_surfaces": [
            ...
            },
            {
                ...
                "purpose": "Deterministic templates for hard archive-science questions (cycle counts, array combos, line sets).",
        ...
        "tables": {
            "ivoa.obscore": {
                ...
                "columns": [
                    ...
                    {"name": "cont_sens_bandwidth", "dtype": "float", "unit": "mJy/beam", "role": "measurement",
                     "description": "Continuum sensitivity over the full bandwidth."},
