...
"""
Unit tests for the Sandbox Environment.

Tests sandbox safety, context helpers, and code execution.
"""

import pytest
from core.sandbox import SandboxEnvironment, ExecutionResult, _is_safe
...
class TestSandboxEnvironment:
    def setup_method(self):
        self.env = SandboxEnvironment(SAMPLE_CONTEXT)
...
# ---------------------------------------------------------------------------
# Complexity detection (from core.complexity)
# ---------------------------------------------------------------------------
